...
return ( <div className="min-h-screen flex flex-col justify-center items-center bg-gray-50"> <h1 className="text-3xl font-bold mb-4">Login to Diplo</h1>
{loginMessage && <div className="text-red-600 mb-4">{loginMessage}</div>} <button
